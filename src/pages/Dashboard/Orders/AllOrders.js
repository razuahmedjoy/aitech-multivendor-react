...
const columns = [
    ...
    },
    {
        name: 'Action',
        sortable: true,
        cell: () => (<div className="flex gap-x-1 justify-center">
            <button className="badge badge-error cursor-pointer" title="delete">
                <TiDelete className="text-white"/>
            </button>
            <button className="badge badge-info cursor-pointer" title="edit">
        ...
        <>
            ...
            <div>
                ...
                <div className="mb-2">
                    ...
                    <select className="select select-sm rounded-md">
                        <option disabled selected>Choose Action</option>
                        <option>Edit order status</option>
                        <option>Assignment to Employee</option>
                        <option>Invoice printing</option>
                        <option>Print Billing Summary</option>
                        <option>Policy Printing</option>
                        <option>Export Orders</option>
                    </select>
                    <button className="ml-5 btn btn-primary text-white font-normal btn-sm">Process</button>
                    <Link to="/dashboard/add-order" className="ml-5 btn btn-secondary text-white font-normal btn-sm">Add New Order</Link>
