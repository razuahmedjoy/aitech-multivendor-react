...
const data = [
    { id: 1, category: "Helen Banks", slug: "Brainlounge", description: "lorem lorem lorem"},
    { id: 2, category: "Russell Wright", slug: "Trilith", description: "lorem lorem"},
    { id: 3, category: "Phillip Franklin", slug: "Babbleopia", description: "lorem lorem" },
...
const Categories = () => {
    return (
        <>
            <h2 className="text-title text-lg md:text-2xl pb-2 uppercase">Categories</h2>
